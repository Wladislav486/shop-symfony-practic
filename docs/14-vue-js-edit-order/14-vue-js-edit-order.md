...
1. Реализовать фун-ал просмотра товара при добавлении его в заказ
2. Реализовать фун-ал добавления товара к заказу
...
7. Реализуем настройки API Platform для сущности Order, тк при добавлении нового товара к заказу поле заказа - ссылка на
   товары, должно меняться
